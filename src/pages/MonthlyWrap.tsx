...
export default function MonthlyWrap() {
  ...
  return (
    <div className="page-content min-h-full pb-8 bg-[radial-gradient(circle_at_20%_20%,rgba(168,85,247,0.2),transparent_35%),radial-gradient(circle_at_80%_10%,rgba(34,211,238,0.16),transparent_32%),radial-gradient(circle_at_50%_120%,rgba(244,114,182,0.12),transparent_45%),hsl(var(--background))]">
